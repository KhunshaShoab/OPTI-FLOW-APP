          ...
          {row.map((t, i) => (
            <div key={i} className="glass w-[380px] flex-none p-7 animate-float" style={{ animationDelay: `${(i % 3) * -2.3}s` }}>
              ...
              <div className="mt-6 flex items-center gap-3">
                <span className="grid h-11 w-11 place-items-center rounded-full font-display font-bold text-white" style={{ background: "linear-gradient(140deg,#F97316,#3B82F6)" }}>{t.av}</span>
